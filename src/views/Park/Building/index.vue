    ...
    <div class="table">
      ...
      >
        ...
        <el-table-column label="操作" prop="demoFlag">
          <template #default="scope">
            <el-button size="mini" :disabled="demoFlag === 1" type="text" @click="editBuilding(scope.row.id)">编辑</el-button>
            <el-button size="mini" :disabled="demoFlag === 1" type="text" @click="deleteBuilding(scope.row.id)">删除</el-button>
          </template>
        </el-table-column>
      </el-table>
    </div>
